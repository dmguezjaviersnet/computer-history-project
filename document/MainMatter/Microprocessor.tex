...
unidad de procesamiento central (\textbf{CPU}), el 4004, así como un \textbf{chip} de memoria de solo lectura (\textbf{ROM}) compatible para los programas de
...
sino de \textbf{CTC}. El 8008 salió con 3.500 transistores, tenía un bus de datos de 8 bits y un bus de direcciones de 14 bits. Este
