...
\emph{Intel} creó su primer \textbf{procesador} \textbf{RISC} en 1984 \brackcite{wikipedia_2022_RISC}. No fue diseñado como un competidor directo de los procesadores 
...
\subsection{\textbf{Nehalem}: El primer \textbf{Core i7}}
...
completamente internamente, \emph{AMD} no produciría un \textbf{procesador} diseñado por él mismo durante varios años \brackcite{sexton_2017_history_of_AMD_cpus}. 
...
\textbf{FPU} integrada \brackcite{sexton_2017_history_of_AMD_cpus}. 
...
esencialmente variaciones muy modificadas del K7. Al pasar a un diseño de 64 bits, \emph{AMD} pudo ampliar el soporte de memoria a 1 TB teórico \brackcite{sexton_2017_history_of_AMD_cpus}.
